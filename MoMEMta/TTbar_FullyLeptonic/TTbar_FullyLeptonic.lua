...
load_modules('/afs/cern.ch/user/s/sblancof/miniconda3/envs/ME/TTbar_FullyLeptonic/build/libme_myHappyME.so')
...
--
    ...
    MatrixElement.ttbar = {
      ...
      matrix_element_parameters = {
          card = '/afs/cern.ch/user/s/sblancof/miniconda3/envs/ME/TTbar_FullyLeptonic/Cards/param_card.dat'
      },
