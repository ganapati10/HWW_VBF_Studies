...
src = "rootFile/plots_WW_2016_CP.root"
dst_hvv = "rootFileJJH/plots_JJH_HVV.root"
dst_hgg = "rootFileJJH/plots_JJH_HGG.root"

othertemp_hvv = ['DATA','WW', 'ggWW', 'WWewk', 'top','DY', 'Fake_me', 'Fake_em', 'Dyemb', 'VVV', 'VZ', 'WZ', 'ZZ', 'Vg', 'Wg', 'VgS_H','VgS_L', 'H_htt', 'H_hww', 'ZH_hww', 
                 'ggZH_hww', 'WH_hww','bbH_hww','ttH_hww', 'qqH_htt', 'ggH_htt', 'ggH_hww']
...
#print " " 
#print "- For VBF HVV (1V) need templates T1 -(2,0), T2 -(1,1), T3 -(0,2)" 
#print "Get from SM-BSM MC : SM(1,0), BSM(0,1), M1(1,gMix) "
#print "- Will create new file : "+dst_hvv+" with HVV analysis templates"
print " "
print "- For VBF+2Jet HGG (1V) need templates T1 -(2,0), T2 -(1,1), T3 -(0,2)" 
print "Get from SM-BSM MC : SM(1,0), BSM(0,1), M1(1,gMix) "
...
def create1VIntTemplates(Cat, Var, Prod, AC, Sys, Test):
 ...
 Gsc = cons[Prod+AC] # Fai in terms of WW decay vertex or VBF production vertex
...
VBFConfig = [ ("SRVBF", "D_int_hm_2", "VBF_", "H0M"),
...
AddOtherTemplates("SRVBF", "D_int_hm_2", "H0M"),
AddOtherTemplates("SRVBF", "D_int_hp_2", "H0PH"),
AddOtherTemplates("SRVBF", "D_int_hm_2", "H0L1"),
